...
CmdHelp("managers").add_command(
  "ls_local", None, "Gives the list of downloaded medias in your GodFtaher server."
).add_command(
  "ls_root", None, "Gives the list of all files in root directory of GodFtaher repo."
).add_command(
  "ls_saved", None, "Gives the list of all files in Saved directory of your GodFtaher server"
).add_command(
